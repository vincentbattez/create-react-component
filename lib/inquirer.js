...
module.exports = {
  ...
  askSubmit: (data) => {
    ...
    global.perform = {
      distPath: distPath,
      component: {
        fullPath: `${distPath}/${data.name}.${data.componentExt}`,
        fileName: `${data.name}.${data.componentExt}`
      },
      container: {
        fullPath: `${distPath}/${data.name}.container.${data.componentExt}`,
        fileName: `${data.name}.container.${data.componentExt}`
      },
      style: {
        fullPath: `${distPath}/${data.name}.${data.styleExt}`,
        fileName: `${data.name}.${data.styleExt}`
      },
      stories: {
        fullPath: `${distPath}/${data.name}.stories.${data.componentExt}`,
        fileName: `${data.name}.stories.${data.componentExt}`
      },
      type: {
        fullPath: `${distPath}/${data.name}.type.ts`,
        fileName: `${data.name}.type.ts`
      },
      index: {
        fullPath: `${distPath}/index.${files.buildExtension(data.componentExt)}`,
        fileName: `index.${files.buildExtension(data.componentExt)}`
      },
    };
